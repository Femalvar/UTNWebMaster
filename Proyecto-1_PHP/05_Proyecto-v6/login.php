...
<?php
        ...
        $loginClave = $_REQUEST['claveUser'];

        // conexion MYSQL
        include "conexion.php";

        //Verificar si el mail usuario y el pass coinciden con usuria registrado, hay login...creamos las sesiones
        $consultaLogin = mysqli_query($conexion, "SELECT id, nombre, apellido, email FROM usuarios WHERE email='$loginEmail' and claveUser='$loginClave'");

        $verificar = mysqli_num_rows($consultaLogin);

        if($verificar == 0){
             
            echo "<script>alert('Los datos no coinciden con un usuario registrado. Intentalo nuevamente.');document.location='index.php'</script>";
            ...
            $user = mysqli_fetch_array($consultaLogin);
            ...
            <div class="container bg-dark mb-0 py-1">
                <nav class="row">
                    ...
                    <div class="col-10 text-end nav-header">
                        <button type="button" class="btn btn-outline-light border-dark m-2" data-bs-toggle="modal" data-bs-target="#PerfilModal">
                ...
                <div id="carouselExampleSlidesOnly" class="container p-0 carousel slide" data-bs-ride="carousel">
                    <div class="carousel-inner">
                      ...
                      <div class="carousel-item">
                        <div class="position-absolute text-slider mx-5 mt-3 col-sm-12 col-md-8 col-lg-10">
                            <p class="text-slider lh-sm">compra y vende sin comisión</p>
                      ...
                      <div class="carousel-item">
                        <div class="position-absolute text-slider mx-5 mt-3 col-sm-12 col-md-8 col-lg-8">
                            <p class="text-slider lh-sm">operación directa entre partes</p>
                            <button type="button" class="bt-slider btn btn-warning"><span>PUBLICAR</span></button>
                        </div>
                        ...
                        <div class="row m-0 p-0">
                            ...
                            <article class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="card_ano-kms">Año 2016. 105000km.</div>
                            ...
                            <article class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="card_ano-kms">Año 2018. 78000km.</div>
                            ...
                            <article class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <h5 class="card_marca">TOYOTA PIRULEX</h5>
                                        <div class="card_ano-kms">Año 2020. 35000km.</div>
                            ...
                            <article class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <h5 class="card_marca">HUNDAI SARASA</h5>
                                        <div class="card_ano-kms">Año 2014. 198000km.</div>
    ...
    <!-- OPEN MODAL REGIStRO OK -->
    <!-- <script type="text/javascript">
        var RegistroOK = new bootstrap.Modal(document.getElementById('RegistroOK'), {})
        RegistroOK.toggle()
    </script>  -->
